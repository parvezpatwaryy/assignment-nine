  ...
  useEffect(() => {
    ...
    const fetchProfileStats = async () => {
      try {
        ...
        try {
          const ideasRes = await fetch(`https://assignment-nine-mu-five.vercel.app/api/ideas/count?email=${user.email}`);
          if (ideasRes.ok) {
        ...
        try {
          const commentsRes = await fetch(`https://assignment-nine-mu-five.vercel.app/api/comments/count?email=${user.email}`);
          if (commentsRes.ok) {
